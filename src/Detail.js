	...
	render() {
		...
		return (
			<React.Fragment>
				...
				<img style={{borderRadius:"12px",width:"88%",marginLeft:"6%",height:"27.6vh",marginBottom:"2vw",marginTop:"4vw"}} src={this.state.itemImg} />
				...
				<div className={style.buttonBox}>
					<button style={{backgroundColor:"#E56862"}} className={style.button}>立即捐款</button>
					<button style={{backgroundColor:"#F59B40"}} className={style.button}>进入投票</button>
				</div>
			</React.Fragment>
		);
	}
